		...
		if (validaciones.size() > 0) {
			...
			try {
				...
				if ( uId > 0 ) {  //modificar 
					...
					request.setAttribute("mensajeAlerta", new Alerta(Alerta.TIPO_PRIMARY, "Los datos del usuario modificados correctamente"));
				...
				request.setAttribute("mensajeAlerta", new Alerta(Alerta.TIPO_DANGER, "El usuario no se puede añadir, su nombre ya existe en la base de datos. Elige otro, por favor"));
			}
		}
